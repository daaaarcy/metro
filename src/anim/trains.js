...
export const ROUTES = [
  ...
  // Kwai Hing is the temporary north end — the TWL climbs out of the
  // Lai King hillside box onto the viaduct and stays elevated through
  // Kwai Fong, berths KWH P1, wraps off-map and re-enters P2 (the
  // opposite side platform) to head back south. MOK/PRE
  ...
  { line: 'TWL', travel: 75, legs: ['tunnel', 'tunnel', 'tunnel', 'tunnel', 'tunnel', 'tunnel', 'tunnel', 'tunnel', 'tunnel', 'tunnel', 'tunnel', 'tunnel', 'tunnel', 'off', 'tunnel', 'tunnel', 'tunnel', 'tunnel', 'tunnel', 'tunnel', 'tunnel', 'tunnel', 'tunnel', 'tunnel', 'tunnel', 'tunnel', 'tunnel', 'off'], consists: 2,
    stops: [{ uid: 'KWH:U1', num: 2 },
            { uid: 'KWF:U1', num: 2 },
            { uid: 'LAK:L5', num: 2 },
            { uid: 'MEF:L3', num: 4 },
            { uid: 'LCK:L2', num: 2 },

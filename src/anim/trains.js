...
export const ROUTES = [
  ...
  // east to Causeway Bay, Tin Hau and Fortress Hill; the consist
  // reverses off-map at Fortress Hill's east portal (Chai Wan
  // direction) and runs back west to KET.
  { line: 'ISL', travel: 80, legs: ['tunnel', 'tunnel', 'tunnel', 'tunnel', 'tunnel', 'tunnel', 'tunnel', 'tunnel', 'tunnel', 'off', 'tunnel', 'tunnel', 'tunnel', 'tunnel', 'tunnel', 'tunnel', 'tunnel', 'tunnel', 'tunnel', 'off'], consists: 4,
    stops: [{ uid: 'KET:L2', num: 1 }, { uid: 'HKU:L2', num: 1 },
            ...
            { uid: 'FOH:L2', num: 1 }, { uid: 'FOH:L3', num: 2 },
